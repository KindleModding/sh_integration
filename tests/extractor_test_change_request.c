...
int main()
{
    ...
    generateChangeRequest(changeRequest, "./tests/test_hooks.sh", uuid, "TestName", "TestAuthor", "TestIcon");
    ...
    generateChangeRequest(changeRequest, "./tests/test_hooks.sh", uuid, NULL, "TestAuthor", "TestIcon");
    ...
    cJSON_Delete(changeRequest);
    changeRequest = cJSON_CreateObject();
    generateChangeRequest(changeRequest, "./tests/test_hooks.sh", uuid, NULL, NULL, "TestIcon");
    ...
    cJSON_Delete(changeRequest);
    changeRequest = cJSON_CreateObject();
    generateChangeRequest(changeRequest, "./tests/test_hooks.sh", uuid, NULL, NULL, NULL);
