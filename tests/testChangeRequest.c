...
int main()
{
    ...
    generateChangeRequest(changeRequest, "./test.sh", uuid, "TestName", "TestAuthor", "TestIcon");
    ...
    generateChangeRequest(changeRequest, "./test.sh", uuid, NULL, "TestAuthor", "TestIcon");
    ...
    cJSON_Delete(changeRequest);
    changeRequest = cJSON_CreateObject();
    generateChangeRequest(changeRequest, "./test.sh", uuid, NULL, NULL, "TestIcon");
    ...
    cJSON_Delete(changeRequest);
    changeRequest = cJSON_CreateObject();
    generateChangeRequest(changeRequest, "./test.sh", uuid, NULL, NULL, NULL);
